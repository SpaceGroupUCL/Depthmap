// salaprogram.cpp - a component of the Depthmap - spatial network analysis platform
...
// this function is called by Depthmap to run a script to update a column
...
// this function is called by Depthmap to run a script to select values
// the operation is on a single node / row of the database combination
