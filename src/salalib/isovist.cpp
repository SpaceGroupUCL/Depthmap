...
void Isovist::makeit(BSPNode *root, const Point2f& p, const Region& region, double startangle, double endangle)
{
...
void Isovist::setData(AttributeTable& table, int row)
{
