...
// 14-Sep-2005: Region bug with segment maps from imported axial maps fixed:
...
public:
   ...
   bool analyseGraph( Communicator *communicator, Options options ); // <- options copied to keep thread safe
   ...
   bool analyseAxial( Communicator *communicator, Options options ); // <- options copied to keep thread safe
