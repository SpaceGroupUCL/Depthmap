...
const AttrMap g_attr_display_map[] = {
   // 0
   AttrMap(AttrHeader::NEIGHBOURHOOD_SIZE, "Neighbourhood Size",  GraphVertexList::BASIC,      0,  AttrMap::ATTR_INT), 
   AttrMap(AttrHeader::MEAN_DEPTH,         "Mean Depth",          GraphVertexList::GLOBAL,     0,  AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::INTEGRATION_RA,     "Relative Asymmetry",  GraphVertexList::GLOBAL,     0,  AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::INTEGRATION_RRA,    "Real Relative Asymmetry*", GraphVertexList::GLOBAL,0,  AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::INTEGRATION_HILL,   "Integration (Hillier/Hanson)*",  GraphVertexList::GLOBAL, 0, AttrMap::ATTR_FLOAT), 
   // 5
   AttrMap(AttrHeader::INTEGRATION_TEKL,   "Integration (Teklenburg et al.)",  GraphVertexList::GLOBAL, 0, AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::GRAPH_SIZE,         "Graph Size",          GraphVertexList::GLOBAL,     0,  AttrMap::ATTR_INT), 
   AttrMap(AttrHeader::ENTROPY,            "Entropy",             GraphVertexList::GLOBAL,     0,  AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::REL_ENTROPY,        "Relativised Entropy", GraphVertexList::GLOBAL,     0,  AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::CLUSTER,            "Clustering Coefficient", GraphVertexList::LOCAL,   0,  AttrMap::ATTR_FLOAT), 
   // 10
   AttrMap(AttrHeader::CONTROL_HILL,       "Control (Hillier/Hanson)", GraphVertexList::LOCAL, 0,  AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::CONTROL_TURN,       "Control (Turner)",    GraphVertexList::LOCAL,      0,  AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::POINT_DEPTH,        "Point Depth",         GraphVertexList::POINTDEPTH, 0,  AttrMap::ATTR_INT),
   AttrMap(AttrHeader::MEDIAN_ANGLE,       "Mean Angle",          GraphVertexList::ANGULAR,    0,AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::FAR_DIST,           "Far Neighbour Distance",     GraphVertexList::BASIC,      0,  AttrMap::ATTR_FLOAT),
   // 15
   AttrMap(AttrHeader::TOTAL_DIST,         "Total Neighbour Distance",   GraphVertexList::BASIC,      0,    AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::AVG_DIST,           "Average Neighbour Distance", GraphVertexList::BASIC,      0,    AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::AGENT_COUNT,        "Agent Trails",        GraphVertexList::BASIC,      0, AttrMap::ATTR_INT),
   AttrMap(AttrHeader::AGENT_COLL_COUNT,   "Agent Collisions",    GraphVertexList::BASIC,      0, AttrMap::ATTR_INT),
   AttrMap(AttrHeader::METRIC_MEAN_DEPTH,  "Metric Mean Depth",   GraphVertexList::METRIC,     0,    AttrMap::ATTR_FLOAT),
   // 20
   AttrMap(AttrHeader::METRIC_MEAN_ANGLE,  "Metric Mean Angle",      GraphVertexList::METRIC,     0,    AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::MEAN_PENN_DIST,     "Mean Penn Distance",        GraphVertexList::METRIC, 0,  AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::DECENTRAL_INTEG,    "Decentralised Integration", GraphVertexList::METRIC, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::METRIC_POINT_DEPTH, "Metric Point Depth",        GraphVertexList::METRICPOINTDEPTH, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::METRIC_POINT_ANGLE, "Metric Point Angle",        GraphVertexList::METRICPOINTDEPTH, 0, AttrMap::ATTR_FLOAT),
   // 25
   AttrMap(AttrHeader::POINT_PENN_DIST,    "Point Penn Distance",       GraphVertexList::METRICPOINTDEPTH, 0, AttrMap::ATTR_FLOAT)
};
...
const AttrMap g_attr_summary_map[] = {
   // 0
   AttrMap(AttrHeader::NEIGHBOURHOOD_SIZE, "Neighbourhood Size",     1, 0, AttrMap::ATTR_INT),
   AttrMap(AttrHeader::FAR_DIST,           "Far Neighbour Distance", 1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::TOTAL_DIST,         "Total Neighbour Distance", 1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::GRAPH_SIZE,         "Graph Size",             1, 0, AttrMap::ATTR_INT), 
   AttrMap(AttrHeader::KERNEL_SIZE,        "Kernel Size",            1, 0, AttrMap::ATTR_INT), 
   // 5
   AttrMap(AttrHeader::CLIQUE_SIZE,        "Clique Size",            1, 0, AttrMap::ATTR_INT), 
   AttrMap(AttrHeader::TOTAL_DEPTH,        "Total Visual Depth",     1, 0, AttrMap::ATTR_INT), 
   AttrMap(AttrHeader::ENTROPY,            "Entropy",                1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::REL_ENTROPY,        "Relativised Entropy",    1, 0, AttrMap::ATTR_FLOAT), 
   AttrMap(AttrHeader::CLUSTER,            "Clustering Coefficient", 1, 0, AttrMap::ATTR_FLOAT), 
   // 10
   AttrMap(AttrHeader::POINT_DEPTH,        "Point Depth",            1, 0, AttrMap::ATTR_INT),
   AttrMap(AttrHeader::CONTROL_HILL,       "Control (Hillier/Hanson)", 1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::CONTROL_TURN,       "Control (Turner)",       1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::MEDIAN_ANGLE,       "Mean Angle",             1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::AGENT_COUNT,        "Agent Trails",           1, 0, AttrMap::ATTR_INT),
   // 15
   AttrMap(AttrHeader::AGENT_COLL_COUNT,   "Agent Collisions",       1, 0, AttrMap::ATTR_INT),
   AttrMap(AttrHeader::TOTAL_METRIC_DEPTH, "Total Metric Depth",     1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::TOTAL_METRIC_ANGLE, "Total Metric Angle",     1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::TOTAL_EUCLID_DIST,  "Total Euclidean Distance", 1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::METRIC_GRAPH_SIZE,  "Metric Graph Size",      1, 0, AttrMap::ATTR_INT),
   // 20
   AttrMap(AttrHeader::METRIC_POINT_DEPTH, "Metric Point Depth",     1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::METRIC_POINT_ANGLE, "Metric Point Angle",     1, 0, AttrMap::ATTR_FLOAT),
   AttrMap(AttrHeader::POINT_EUCLID_DIST,  "Euclidean Point Depth",  1, 0, AttrMap::ATTR_FLOAT)
};
