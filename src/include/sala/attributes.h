...
public:
   ...
   { m_name = name; m_min = -1.0f; m_max = 0.0f; m_tot = 0.0; m_visible_min = -1.0f; m_visible_max = 0.0f; m_visible_tot = 0.0;
    m_physical_col = physical_col; m_hidden = false; m_locked = false; m_updated = false; }
